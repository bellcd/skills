...
| Skill                                                                  | Description                                                                                                                                                     |
| ---------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [code-style](skills/code-style/SKILL.md)                               | Coding conventions. Use when writing, editing, installing, or reviewing code of any kind.                                                                      |
| [git-and-github-hygiene](skills/git-and-github-hygiene/SKILL.md)       | Conventions for branching, committing, pushing, pull requests, and GitHub issues. Use when committing, opening or updating a PR, or creating, editing, or closing an issue. |
| [tight-feedback-loops](skills/tight-feedback-loops/SKILL.md)           | Conventions for scoping work into slices, verifying it, and handing back results. Use when planning a chunk of work, running tests to verify it, or reporting a result. |
